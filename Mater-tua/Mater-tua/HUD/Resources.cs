    ...
    public void draw(SpriteBatch s)
    {
        switch (getNumber())
        {
            ...
            case 1: /* gold */
                ...
                s.DrawString(GameEnvironment.getAssetManager().getFont("Warcraft Font"), "Gold: " + Player.Gold, new Vector2((int)GameEnvironment.getCamera().getScreenSize().X - 390, 10), Color.Red);
                break;
            ...
            case 2: /* wood */
                ...
                s.DrawString(GameEnvironment.getAssetManager().getFont("Warcraft Font"), "Wood: " + Player.Wood, new Vector2((int)GameEnvironment.getCamera().getScreenSize().X - 245, 10), Color.Red);
                break;
            ...
            case 3: /* food */
                ...
                s.DrawString(GameEnvironment.getAssetManager().getFont("Warcraft Font"), "Food: " + Player.Food, new Vector2((int)GameEnvironment.getCamera().getScreenSize().X - 100, 10), Color.Red);
                break;
        }
    }
}