...
internal class HUD
{
    ...
    public virtual void draw(SpriteBatch spriteBatch)
    {
        ...
        for (int i = (int)GameEnvironment.getCamera().getScreenSize().X - 3 * _tex.Width + 50; i + _tex.Width <= GameEnvironment.getCamera().getScreenSize().X + _tex.Width; i += _tex.Width)
